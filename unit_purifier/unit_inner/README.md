...
The purifiers electronics are mostly placed within the filter (TODO :: link to filter). This part assembles motor, sensors, an arduino nano and the motor driver.
